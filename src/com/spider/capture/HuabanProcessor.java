...
public class HuabanProcessor implements PageProcessor {
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new HuabanProcessor()).thread(5).pipeline(new FilePipeline("/data/webmagic/test/")).downloader(new SeleniumDownloader(rootPath + "/spider-test/document\\driver\\chromedriver.exe")).runAsync();
    }
}