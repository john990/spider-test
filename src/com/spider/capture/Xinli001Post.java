...
public class Xinli001Post implements PageProcessor {
	private Site site = Site.me().setDomain("xinli001.com").addStartUrl("http://www.xinli001.com/info/");
	...
	public void process(Page page) {
		...
		String content = page.getHtml().xpath("//div[@class='show_contents']").toString();
		// 3-23
