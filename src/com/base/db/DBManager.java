...
public class DBManager {
	...
	private final static Log log = LogFactory.getLog(com.base.db.DBManager.class);
	...
	private final static void initDataSource(Properties dbProperties) {
		try {
			if (dbProperties == null) {
				...
				dbProperties.load(com.base.db.DBManager.class.getResourceAsStream("db.properties"));
			}
